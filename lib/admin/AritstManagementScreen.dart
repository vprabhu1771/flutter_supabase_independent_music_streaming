...
import 'package:flutter_supabase_independent_music_streaming/admin/artist/AddEditArtistScreen.dart';
import 'package:flutter_supabase_independent_music_streaming/admin/artist/ArtistDetailScreen.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

import '../widgets/CustomDrawer.dart';

class AritstManagementScreen extends StatefulWidget {

  final String title;

  const AritstManagementScreen({super.key, required this.title});

  @override
  State<AritstManagementScreen> createState() => _AritstManagementScreenState();
}

class _AritstManagementScreenState extends State<AritstManagementScreen> {
